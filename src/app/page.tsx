    ...
    <div className="page-shell flex flex-col gap-8">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <div className="panel p-6">
          ...
          <p className="mt-3 text-4xl font-bold text-[color:var(--brand)]">{products.length}</p>
          ...
          {categories.map((item) => {
            ...
            return (
              <Link
                ...
                className={`panel flex min-h-[160px] flex-col justify-between bg-gradient-to-br ${item.accent} p-5 transition-transform hover:-translate-y-0.5`}
              >
                <div className="flex items-center justify-between">
                  <div className="rounded-full bg-white/70 p-3 text-[color:var(--brand)]">
